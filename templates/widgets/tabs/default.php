<ul class="nav nav-tabs">
	<?php if($show_popular_posts == 'true'): ?>
		<li class="active">
			<a href="#tab-popular" data-toggle="tab"><?php echo esc_html__('Popular', 'training' ); ?></a>
		</li>
	<?php endif; ?>
	<?php if($show_recent_posts == 'true'): ?>
		<li <?php if($show_popular_posts != 'true') echo 'class="active"'; ?>>
			<a href="#tab-recent" data-toggle="tab"><?php echo esc_html__('Recent', 'training' ); ?></a>
		</li>
	<?php endif; ?>
	<?php if($show_comments == 'true'): ?>
		<li <?php if($show_popular_posts != 'true' && $show_recent_posts != 'true' ) echo 'class="active"'; ?>>
			<a href="#tab-comments" data-toggle="tab"><?php echo esc_html__('Comments', 'training' ); ?></a>
		</li>
	<?php endif; ?>
</ul>
			...
			<div class="post-widget media-post-layout">
				...
				<article class="item-post media">
					...
					<div class="media-body">
						...
						<p class="post-date">
							<?php echo esc_html__('Posted: ','training'); ?>
							<?php the_time( 'd M Y' ); ?>
						</p>
						<p class="post-author">
		...
		<div class="tab-pane" id="tab-comments">
			<div class="post-widget comment-widget media-post-layout">
				...
				<article class="item-post media">
					...
					<div class="media-body">
						<h6 class="entry-title">
							<?php echo strip_tags($comment->comment_author); ?> <?php esc_html__('says', 'training' ); ?>:
						</h6>
