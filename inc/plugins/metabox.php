...
class WPO_MetaBox
{
	...
	?>
        ...
        <label for="meta-checkbox">
            ...
            <?php esc_html_e( 'Enable', 'training' )?>
        </label>
    <?php
	}
	...
	?>
		<label><?php esc_html_e( 'Gallery image: ', 'training')?></label>
        <label id="wp-content-media-buttons">
            <a href="#" class="button insert-media add_media" data-editor="content" title="Add Media">
                <span class="wp-media-buttons-icon"></span><?php esc_html_e('Add Media', 'training'); ?>
            </a>
        </label>
    <?php
	}
...
?>
		<p class="wpo_section page-layout">
		    ...
		    <select  name="<?php $this->the_name(); ?>" style="display:none;">
		    	<option value="fullwidth" <?php $this->the_select_state('fullwidth'); ?>><?php echo esc_html__('Fullwidth','training'); ?></option>
		    	<option value="leftmain" <?php $this->the_select_state('leftmain'); ?>><?php echo esc_html__('Left Sidebar','training'); ?></option>
		    	<option value="mainright" <?php $this->the_select_state('mainright'); ?>><?php echo esc_html__('Right Sidebar','training'); ?></option>
		    	<option value="leftmainright" <?php $this->the_select_state('leftmainright'); ?>><?php echo esc_html__('Left & Right Sidebar','training'); ?></option>
		    </select>
		</p>
<?php
	...
	public function wpo_image_upload( $data ){
		$this->the_field( $data['id']);
...
<?php
	...
	public function wpo_image_enqueue() {
        ...
        wp_register_script( 'meta-box-image', WPO_FRAMEWORK_ADMIN_STYLE_URI. 'js/meta-box-image.js', array( 'jquery' ) );
        wp_localize_script( 'meta-box-image', 'meta_image',
            array(
                'title' => esc_html__( 'Choose or Upload an Image', 'training' ),
                'button' => esc_html__( 'Use this image', 'training'),
            )
        );
