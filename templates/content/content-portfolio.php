...
?>
	...
	<div class="post-container">
		<header class="header-title clearfix">
			<?php if(training_wpo_theme_options('post-title')){ ?>
		...
		<div class="entry-content">
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<h4 class="entry-name">
						<?php esc_html_e('project description','training'); ?>
					</h4>

					<?php if($post->post_content=="") : ?>
						<?php echo '<div class="entry-description">'. esc_html__('Empty Post...!', 'training'). '</div>' ?>
					<?php else : ?>
				...
				<div class="col-lg-4 col-md-4">
					<h4 class="entry-name">
						<?php esc_html_e('Client','training'); ?>
					</h4>
				...
				<div class="col-lg-4 col-md-4">
					<h4 class="entry-name">
						<?php esc_html_e('quick info','training'); ?>
					</h4>
					<ul class="list-unstyled">
						<li>
							<span class="text-primary"><?php esc_html_e('Author:','training'); ?></span>
							<?php the_author(); ?>
						</li>
						<li>
							<span class="text-primary"><?php esc_html_e('Category:','training'); ?></span>
							<?php the_terms( $post->ID, 'category_portfolio' ); ?>
						</li>
						<li>
							<span class="text-primary"><?php esc_html_e('Date:','training'); ?></span>
