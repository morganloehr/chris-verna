...
<section class="widget frontpage-posts section-blog layout-<?php echo esc_attr($layout); ?>  <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    ...
    <div class="widget-content"> 
         ...
         <?php esc_html_e( 'Please select category(ies) to show posts with tab style' , 'training' ); ?>
        ...
        <div class="tab-v2 tabs-left">
            <ul class="nav nav-tabs nav-tabs-hover" role="tablist">
                ...
                <li <?php if($i++==0){ ?>class="active"<?php } ?>>
                    <a aria-expanded="false" href="#<?php echo esc_attr($id).'-'.$catid; ?>" role="tab" data-toggle="tab"><i class="fa fa-heart"></i>  <?php echo get_cat_name( $catid ); ?>  </a>
                </li>
                <?php } ?>
            </ul>
