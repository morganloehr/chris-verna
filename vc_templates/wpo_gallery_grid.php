...
<div class="widget wpo-gallery-grid <?php echo ($padding ? 'gallery-no-padding' : '') ?> <?php echo ($class ? $class : ''); ?>">
    <?php if( $title ) { ?>
    ...
    <div class="widget-content">
        ...
        <?php if($i % $column == 1) echo '<div class="row">' ?>
            <div class="item text-center <?php echo esc_attr( $class_column ); ?> <?php echo ($padding ? 'space-padding-0' : '') ?>">
            	<div class="entry-thumbnail"> 
                	<img src="<?php echo esc_attr($image_attributes[0]); ?>" alt="<?php the_title(); ?>" />
