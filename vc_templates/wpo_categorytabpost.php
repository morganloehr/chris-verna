...
<section class="widget frontpage-posts section-blog layout-<?php echo esc_attr($layout); ?>  <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    ...
    <div class="widget-content">
        ...
        <?php esc_html_e( 'Please select category or more to show posts and the navigator', 'training' ); ?>
        <?php 
            }else { 
            ...
            <div class="frontpage-wrapper">
                ...
                <div class="categories-nav">
                    <ul class="list-inline">
                        ...
                        <li><a href="<?php echo esc_url( get_category_link($catid) ); ?>" title="<?php echo esc_attr( $name ); ?>"><?php echo esc_attr($name); ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
