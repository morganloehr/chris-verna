...
<body <?php body_class(); ?>>
	...
	<section class="wpo-page row-offcanvas row-offcanvas-left"> <?php locate_template('templates/mobile/topbar.php', true);?>
		...
		<section class="wpo-wrapper <?php echo isset($meta_template['el_class']) ? esc_attr( $meta_template['el_class'] ) : '' ; ?>">
				...
				<div class="container">
					<div class="topbar-inner">
						...
						<div class="pull-right">
							...
							<a class="btn btn-outline-light text-white radius-4x border-2 btn-sm" href="<?php echo esc_url( wp_registration_url() ); ?>">Register</a>
							<?php } ?>
						</div>    
					</div>      
				</div>    
			...
			<!-- HEADER -->
			<header id="wpo-header" class="header-absolute space-top-40">
				<section class="wpo-header header-topbar">
					<div class="container-inner">
						<div class="container">
							<div class="header-wrapper row header-quick-action">
								<!-- LOGO -->
								<div id="logo-inner" class="logo-in-theme col-lg-2 col-md-2 col-sm-12 col-xs-12">
								...
								<!-- MENU -->
								<div class="wpo-mainmenu-wrap col-lg-10 col-md-10 col-sm-12 col-xs-12">
 
									<div class="mainmenu-content-wapper">
										<div class="mainmenu-content text-right">
											<nav id="wpo-mainnav" data-duration="<?php echo training_wpo_theme_options('megamenu-duration',400); ?>" class="padding-large style-dark wpo-megamenu <?php echo training_wpo_theme_options('magemenu-animation','slide'); ?> animate navbar navbar-mega" role="navigation">
