...
jQuery( document).ready( function($){
 ...
 if(jQuery('.wpo-video-link').length) {
    jQuery('.wpo-video-link').on('click', function(e) {
        e.preventDefault();
  ...
  if(jQuery('.btn-view-lesson').length){
    jQuery('.btn-view-lesson a').on('click', function(){
...
jQuery('.heading-v1 h2, .heading-v2 h2, .heading-v3 h2, .heading-v4 h2').each(function(){
    var me = jQuery(this)
       , t = me.text().split(' ');
...
jQuery(document).ready(function() {
    var height = 0;
    jQuery('.height-group').each(function(){
        if(height < jQuery(this).height()){
            height = jQuery(this).height();
        }
    });
    jQuery('.height-group').css('height', height);
});
...
jQuery(document).ready(function() {
        ...
        if(jQuery.fn.fullpage){
            var titleSection = [], backgroundSection = [];
            jQuery('#wpo-one-page-content').find('.section').each(function(){
                titleSection.push(jQuery(this).data('onepage-title'));
            });
            jQuery('#wpo-one-page-content').find('.section').each(function(){
                backgroundSection.push(jQuery(this).data('onepage-background'));
            });
            function initFullpage(){
                if (jQuery(window).width() > 780) {
                    jQuery('#wpo-one-page-content').fullpage({
                        sectionsColor: backgroundSection,
                        navigation: true,
