...
if ( $img == NULL ) $img['thumbnail'] = '<img alt="" class="' . esc_attr( $style ) . esc_attr( $border_color ). '" src="' . vc_asset_url( 'vc/no_image.png' ) . '" />'; //' <small>'.esc_html__('This is image placeholder, edit your page to replace it.', 'training').'</small>';
