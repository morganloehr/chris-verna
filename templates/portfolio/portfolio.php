...
<?php if( $portfolio->have_posts()): ?>
  ...
  <?php while($portfolio->have_posts()): $portfolio->the_post();
     $item_classes = 'all ';
     $item_cats = get_the_terms( $portfolio->post->ID, 'category_portfolio' );
...
<?php if($class_column !=3) { ?>
  <p class="entry-description"><?php echo training_wpo_excerpt(20,'...'); ?></p>
<?php } ?>
</div>
