<div class="sharrre-container">
	<span><?php esc_html_e('Share','training'); ?></span>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		jQuery('#twitter').sharrre({
			...
			enableHover: false,
			enableTracking: true,
			buttons: { twitter: {via: '<?php echo training_wpo_theme_options('twitter-username'); ?>'}},
		...
		<?php if ( training_wpo_theme_options( 'sharrre-scrollable' ) == 'on' ): ?>		
